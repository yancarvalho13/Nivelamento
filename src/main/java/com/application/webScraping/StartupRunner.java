...
import com.application.webScraping.service.operadoraSaude.OperadoraSaudeService;
...
public class StartupRunner implements CommandLineRunner {
  ...
  private final OperadoraSaudeEntityService operadoraSaudeEntityService;
  public StartupRunner(OperadoraFinanceiroService operadoraFinanceiroService,
                       OperadoraFinanceiroRepository operadoraFinanceiroRepository, OperadoraSaudeService operadoraSaudeService, OperadoraSaudeEntityService operadoraSaudeEntityService) {
  ...
  private void executarPipelineCompleto() {
    try {
      // 1. Etapas de DOWNLOAD (garantir arquivos disponíveis)
      processAnexoIPdf(); // baixa e extrai Anexo I
      processRelatoriosOperadoras(); // baixa CSV de operadoras
      downloadContabeisPorAno("2023"); // baixa ZIPs de 2023
      downloadContabeisPorAno("2024"); // baixa ZIPs de 2024

      // 2. Etapas de PROCESSAMENTO (somente após downloads)
      ...
      System.err.println("Erro na execução do pipeline: " + e.getMessage());
      e.printStackTrace();
    }
  }
